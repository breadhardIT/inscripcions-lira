...
rid
	...
	$nColumnes = 4;
        ...
        if ($this->_enabledSearch) {
            ...
            <form id="search_form_' . $this->_tableId . '" method="post" action="' . $_SERVER['REQUEST_URI'] . '">
            <table width="100%">
            <tr>';
            ...
            if (isset($this->_gridSearch)) {
                foreach($this->_gridSearch as $idSearch => $search) {
                    ...
                    if ($i == $nColumnes) $output.= '</tr><tr>';                      
                }
            }   
            
            $output.= '</tr>                       
            <tr><td class="normal derecha" colspan="4"><input type="button" value="Filtrar" onclick="document.getElementById(\'search_form_' . $this->_tableId . '\').setAttribute(\'action\', self.location.href); document.getElementById(\'search_form_' . $this->_tableId . '\').submit();">
            </td></tr>
            </table>
            </form>
            </div>
