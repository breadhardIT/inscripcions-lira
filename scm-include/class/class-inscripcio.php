...
class Inscripcio {    
    ...
    public function insert($gestio) {
        ...
        $query .= "tinscripcio_origen, tinscripcio_feec, tinscripcio_autocar, tinscripcio_soci, tinscripcio_pagat ";
        if ($gestio) $query .= ", tinscripcio_observacions, tinscripcio_incidencia, tinscripcio_dorsal";                      
        $query .= ') values (';
        $query .= "'$this->idPersona', '$this->idEsdeveniment', '$this->preu', '$this->agree', ";
        $query .= "'$this->clau', '$this->origen', '$this->feec', '$this->autocar', '$this->soci', '$this->pagat'";      
        if ($gestio) $query .= ", '$this->obs', '$this->incidencia', $this->dorsal";              
        $query .= ')'; 
        $consulta = DB::query($query)->execute(); 
