...
Class Esdeveniment {
    ...
    public function canviarEstat($estat) {
        ...
        $query="UPDATE gmlira_esdeveniments SET tesdeveniments_estat='" .$estat. "' WHERE tesdeveniments_id = '" . $this->id . "'";        
    ...
    public function canviarPublicacio($estat) {
        ...
        $query="UPDATE gmlira_esdeveniments SET tesdeveniments_publicat='" .$estat. "' WHERE tesdeveniments_id = '" . $this->id . "'";
        $consulta = db::query($query)->execute();                 
        $this->publicat = $estat;
