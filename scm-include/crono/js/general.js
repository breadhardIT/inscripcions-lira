...
function personaCarnet (id) {
	var opcions="toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, width=400, height=300, top=85, left=140";
        var pagina = "http://localhost/gestirunners/index.php?ctl=gestirunnersPersonesCarnet&idPersona="+id;
        
	window.open(pagina, 'Carnet', opcions);
}
