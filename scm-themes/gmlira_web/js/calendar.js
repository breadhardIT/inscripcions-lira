...
var languageCode = 'ca';	// Possible values: 	en,ge,no,nl,es,pt-br,fr
...
var pathToImages = 'themes/gmlira_web/images/calendar/';	// Relative to your HTML file
...
switch(languageCode){
	...
	case "es": /* Catalan */
		...
		break;
	case "ca": /* Spanish */
		var monthArray = ['Gener','Febrer','Mar&ccedil;','Abril','Maig','Juny','Juliol','Agost','Setembre','Octubre','Novembre','Desembre'];
		var monthArrayShort =['Gen','Feb','Mar','Abr','Mai','Jun','Jul','Ago','Set','Oct','Nov','Des'];
		var dayArray = ['Dl','Dm','Dx','Dj','Dv','Ds','Dg'];
		var weekString = 'Setmana';
		var todayString = 'Avui &eacute;s';
		break;		
